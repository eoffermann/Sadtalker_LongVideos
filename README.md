...
2. Creating the env and install the requirements.
  ...
  conda create -n sadtalker python=3.10.9
...
## 3. Quick Start
The usage is similar to the original implementation Please read the document [best practices and configuration tips](docs/best_practice.md). 
